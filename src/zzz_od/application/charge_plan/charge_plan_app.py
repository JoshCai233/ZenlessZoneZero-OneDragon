...
class ChargePlanApp(ZApplication):
    ...
    def _get_compendium_resource_digits(self) -> tuple[int, int, int] | None:
        ...
        max_charge_power = int(charge_match.group(2))
        ...
        if backup_charge is None or ether_battery is None:
            return None
        return charge_power, backup_charge, ether_battery
    ...
    def check_charge_power(self) -> OperationRoundResult:
        ...
        self.charge_power, self.backup_charge, self.ether_battery = resource_digits
        ...
        return self.round_success(f'剩余电量 {self.charge_power}')
    ...
    def find_and_select_next_plan(self) -> OperationRoundResult:
        ...
        while True:
            ...
            if need_charge_power > 0 and self.charge_power < need_charge_power:
                if not self._can_restore_charge(need_charge_power - self.charge_power):
